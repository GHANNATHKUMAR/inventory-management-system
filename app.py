                ...
                if selected_id:
                    ...
                    if customer:
                        with st.form("update_customer_form"):
                            name = st.text_input("Customer Name", value=customer_data[1])
                            contact = st.text_input("Contact Information", value=customer_data[2])
        ...
        try:
            ...
            if products:
                ...
                if selected_id:
                    ...
                    product = Products.view_product_id(selected_id)
                    ...
                    if 'new_sale_id' in st.session_state:
                        ...
                        if products:
                            ...
                            if selected_product:
                                ...
                                product_details = Products.view_product_id(product_id)
                                if product_details:
